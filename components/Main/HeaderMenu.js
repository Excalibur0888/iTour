		...
		>
			<View style={styles.headContainer}>
				<TouchableOpacity style={styles.faq}>
					<Icon name='help-circle-outline' size={44} color="white" />
				</TouchableOpacity>
			</View>
			<View style={styles.mainContainer}>
				<TouchableOpacity style={styles.container} onPress={handleVisitWebsite}>
					<Icon name='globe-outline' size={40} color="white" style={{marginHorizontal: 7}}/>
					<Text style={gStyle.text}>Посетите наш сайт</Text>
				</TouchableOpacity>
				<TouchableOpacity style={styles.container}>
					<Icon name='notifications-outline' size={40} color="white" style={{marginHorizontal: 7}}/>
					<Text style={gStyle.text}>Уведомления</Text>
				</TouchableOpacity>
				<TouchableOpacity style={styles.container}>
					<Icon name='contrast-outline' size={40} color="white" style={{marginHorizontal: 7}}/>
					<Text style={gStyle.text}>Сменить тему</Text>
				</TouchableOpacity>
				<TouchableOpacity style={styles.container}>
					<Icon name='star-outline' size={40} color="white" style={{marginHorizontal: 7}}/>
					<Text style={gStyle.text}>Оценить</Text>
				</TouchableOpacity>
				<TouchableOpacity style={styles.container}>
					<Icon name='language-outline' size={40} color="white" style={{marginHorizontal: 7}}/>
					<Text style={gStyle.text}>Язык</Text>
				</TouchableOpacity>
				<TouchableOpacity style={styles.container}>
					<Icon name='chatbubbles-outline' size={40} color="white" style={{marginHorizontal: 7}}/>
